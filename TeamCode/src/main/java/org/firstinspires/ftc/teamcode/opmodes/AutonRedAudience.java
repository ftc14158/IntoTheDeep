...
@Autonomous(name="Auton RED AUDIENCE")
public class AutonRedAudience extends CommandOpMode {
    private RobotContainer m_robot;

    private TeamPropDetector visionProcessor1;

    private static TeamPropDetector.AllianceColor forceColor = TeamPropDetector.AllianceColor.RED;
    private static Boolean forceBackstage = false;
