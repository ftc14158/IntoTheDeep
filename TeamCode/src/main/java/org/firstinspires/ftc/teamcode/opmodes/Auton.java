...
import org.firstinspires.ftc.teamcode.commands.AutoTestCommand;
...
public class Auton extends CommandOpMode {
    ...
    private static TeamPropDetector.AllianceColor forceColor = TeamPropDetector.AllianceColor.UNKNOWN;
    private static Boolean forceBackstage = null;
