...
public class TrajectorySequenceRunner {
    ...
    public @Nullable
    DriveSignal update(Pose2d poseEstimate, Pose2d poseVelocity, TelemetryPacket mainPacket) {
        Pose2d targetPose = null;
        DriveSignal driveSignal = null;


        TelemetryPacket packet = mainPacket == null ? new TelemetryPacket() : mainPacket;
        ...
        if (mainPacket == null && dashboard != null) dashboard.sendTelemetryPacket(packet);
